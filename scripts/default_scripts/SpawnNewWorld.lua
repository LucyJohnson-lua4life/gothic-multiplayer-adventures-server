...
function InitNewWorldNPC()
  ...
  SpawnNPC(Scavenger(), "NW_FARM1_OUT_13", world);
  -----Stonehendge ---
  ...
  SpawnNPC(OrcElite(), "NW_XARDAS_TOWER_04", world);
  SpawnNPC(OrcElite(), "NW_XARDAS_PATH_FARM1_11", world);
  SpawnNPC(OrcElite(),"NW_XARDAS_GOBBO_01", world);
  SpawnNPC(OrcElite(),"NW_XARDAS_GOBBO_02", world);
  ...
  --SpawnNPC(Wolf(),"NW_XARDAS_TOWER_WATERFALL_CAVE_ENTRANCE_05", world);
  --SpawnNPC(Wolf(),"NW_XARDAS_TOWER_WATERFALL_CAVE_ENTRANCE_05", world);
  --SpawnNPC(Wolf(),"NW_XARDAS_TOWER_WATERFALL_CAVE_ENTRANCE_GOBBO", world);
  --SpawnNPC(Wolf(), "NW_XARDAS_TOWER_WATERFALL_CAVE_SIDE_02", world); 
  --SpawnNPC(Wolf(), "NW_XARDAS_TOWER_WATERFALL_CAVE_SIDE_02", world);
  -----im Tal---
  SpawnNPC(Wolf(), "NW_XARDAS_VALLEY_03", world); 
  SpawnNPC(Wolf(), "NW_XARDAS_VALLEY_04", world);  
  SpawnNPC(OrcElite(), "NW_XARDAS_VALLEY_06", world); 
  SpawnNPC(OrcWarrior(), "NW_XARDAS_VALLEY_08", world); 
  SpawnNPC(OrcWarrior(), "NW_XARDAS_TOWER_VALLEY_RAT", world); 
  SpawnNPC(Wolf(), "NW_XARDAS_TOWER_VALLEY_WOLF", world);
  ...
  SpawnNPC(Wolf(), "NW_BIGFARM_FELDREUBER", world); 
  SpawnNPC(Wolf(), "NW_BIGFARM_FELDREUBER2", world);
  SpawnNPC(Wolf(), "NW_BIGFARM_FELDREUBER4", world);
  SpawnNPC(Wolf(), "FP_ROAM_MONSTERMILL_11", world);
  SpawnNPC(Wolf(), "FP_ROAM_MONSTERMILL_13", world);
  SpawnNPC(Wolf(), "FP_ROAM_MONSTERMILL_04", world);
  SpawnNPC(Wolf(), "FP_ROAM_MONSTERMILL_03", world);
  ...
  SpawnNPC(Warg(),"NW_FARM4_WOOD_MONSTER_09", world); 
  SpawnNPC(Warg(),"NW_FARM4_WOOD_MONSTER_10", world); 
   
    -- Crypt 
  SpawnNPC(Skeleton(), "FP_CRYPT_ADDON_01", world)
  SpawnNPC(Skeleton(), "FP_CRYPT_ADDON_02", world)
  SpawnNPC(Skeleton(), "FP_CRYPT_ADDON_03", world)
  SpawnNPC(Skeleton(), "FP_CRYPT_ADDON_04", world)
  SpawnNPC(Skeleton(), "FP_CRYPT_ADDON_05", world)
  SpawnNPC(Skeleton(), "FP_CRYPT_ADDON_06", world)

  SpawnNPC(SkeletonLord(), "EVT_CRYPT_ROOM_01_SPAWNMAIN", world);
  SpawnNPC(SkeletonLord(), "EVT_CRYPT_ROOM_02_SPAWNMAIN", world);
  SpawnNPC(SkeletonLord(), "EVT_CRYPT_ROOM_03_SPAWNMAIN", world);--3584
  ...
  SpawnNPC(Zombie2(), "FP_ROAM_CASTLEMINE2_09", world);
  ...
  SpawnNPC(Zombie2(), "FP_ROAM_CASTLEMINE2_13", world);
  ...
  SpawnNPC(Gobbo_Warrior(), "FP_ROAM_BIGFARM_LAKE_CAVE_02", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_07", world);
  SpawnNPC(Gobbo_Warrior(), "FP_ROAM_BIGFARM_LAKE_CAVE_08", world);
  --SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_09", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_10", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_11", world);
  --SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_12", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_13", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_NW_BIGFARMFORESTCAVE_05", world);
  --SpawnNPC(Gobbo_Black(), "FP_ROAM_NW_BIGFARMFORESTCAVE_06", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_NW_BIGFARMFORESTCAVE_07", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_NW_BIGFARMFORESTCAVE_08", world);
  --SpawnNPC(Gobbo_Black(), "FP_ROAM_NW_BIGFARMFORESTCAVE_09", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_NW_BIGFARMFORESTCAVE_10", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_01", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_02", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_03", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_04", world);
  SpawnNPC(Gobbo_Black(), "FP_ROAM_BIGFARM_LAKE_CAVE_05", world);
  ...
  SpawnNPC(Scavenger(),"NW_PASS_SECRET_06", world);
  SpawnNPC(Scavenger(),"NW_PASS_SECRET_07", world);
  ...
  SpawnNPC(OrcElite(),"NW_PASS_ORKS_10", world);
  ...
  SpawnNPC(Scavenger(), "FP_ROAM_MEDIUMFOREST_KAP2_34", world);
  SpawnNPC(Skeleton(), "FP_ROAM_MEDIUMFOREST_KAP3_04", world);
  SpawnNPC(Skeleton(), "FP_ROAM_MEDIUMFOREST_KAP3_05", world);
  SpawnNPC(Zombie2(), "FP_ROAM_MEDIUMFOREST_KAP3_01", world);
  ...
  SpawnNPC(Wolf(), "FP_ROAM_MEDIUMFOREST_KAP3_15", world);
  ...
  SpawnNPC(OrcWarrior(), "FP_ROAM_FISHERMAN_04", world);
  --4095
  
  --4100
  SpawnNPC(Wolf(), "NW_CITY_TO_FOREST_05", world);
  SpawnNPC(Wolf(), "NW_CITY_TO_FOREST_07", world);
  SpawnNPC(Scavenger(), "NW_CITY_TO_FOREST_11", world);
  SpawnNPC(Scavenger(), "NW_CITY_TO_FOREST_12", world);
  SpawnNPC(Wolf(), "NW_CITY_TO_FOREST_15", world); --FPs fehlen
  SpawnNPC(Wolf(), "FP_ROAM_CITY_TO_FOREST_47", world);
  SpawnNPC(Scavenger(), "FP_ROAM_CITY_TO_FOREST_11", world);
  SpawnNPC(Scavenger(), "FP_ROAM_CITY_TO_FOREST_10", world);
  SpawnNPC(Scavenger(), "FP_ROAM_CITYFOREST_KAP3_22", world);
  SpawnNPC(Scavenger(), "FP_ROAM_CITYFOREST_KAP3_20", world);
  SpawnNPC(Scavenger(), "FP_ROAM_CITYFOREST_KAP3_21", world);
  SpawnNPC(Wolf(), "FP_ROAM_CITYFOREST_KAP3_23", world);
  SpawnNPC(Wolf(), "FP_ROAM_CITYFOREST_KAP3_27", world);
  SpawnNPC(Wolf(), "FP_ROAM_CITYFOREST_KAP3_28", world);
  SpawnNPC(Wolf(), "FP_ROAM_CITYFOREST_KAP3_29", world);
  SpawnNPC(Wolf(), "FP_ROAM_CITYFOREST_KAP3_30", world);
  SpawnNPC(Wolf(), "FP_ROAM_CITYFOREST_KAP3_38", world);
  ...
  SpawnNPC(DragonSnapper(), "FP_BLACK_TROLL_DUNGEON_01", world);
  SpawnNPC(DragonSnapper(), "FP_BLACK_TROLL_DUNGEON_02", world);
  SpawnNPC(DragonSnapper(), "FP_BLACK_TROLL_DUNGEON_03", world);
  SpawnNPC(Razor(), "FP_BLACK_TROLL_DUNGEON_04", world);
  SpawnNPC(Razor(), "FP_BLACK_TROLL_DUNGEON_05", world);
  SpawnNPC(Razor(), "FP_BLACK_TROLL_DUNGEON_06", world);
  SpawnNPC(DragonSnapper(), "FP_BLACK_TROLL_DUNGEON_07", world);
  SpawnNPC(DragonSnapper(), "FP_BLACK_TROLL_DUNGEON_08", world);
 ...
 -- SpawnNPC(MinecrawlerWarrior(), "FP_ROAM_RITUALFOREST_CAVE_09", world);
  ...
  SpawnNPC(Stoneguardian(), "FP_MAYA_DUNGEON_11", world);
  SpawnNPC(Stoneguardian(), "FP_MAYA_DUNGEON_12", world);

  SpawnNPC(GraveGuard(), "FP_MAYA_DUNGEON_13", world);
  SpawnNPC(Stoneguardian(), "FP_MAYA_DUNGEON_14", world);
  ...
  SpawnNPC(Firewaran(), "FP_ROAM_NW_TROLLAREA_RUINS_24", world);
  SpawnNPC(OrcElite(), "FP_ROAM_NW_TROLLAREA_RUINS_28", world);
  ...
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS03", world);
  SpawnNPC(OrcShaman(), "FP_ORCS_AT_XARDAS04", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS05", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS06", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS07", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS08", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS09", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS10", world);
  SpawnNPC(OrcWarrior(), "FP_ORCS_AT_XARDAS11", world);
  ...
  SpawnNPC(OrcElite(), "FP_RANDOM_ELITE_ORC_03", world);

  SpawnNPC(OrcWarrior(), "FP_RANDOM_ORC_GROUP1_01", world);
  SpawnNPC(OrcWarrior(), "FP_RANDOM_ORC_GROUP1_02", world);
  SpawnNPC(OrcWarrior(), "FP_RANDOM_ORC_GROUP1_03", world);
  ...
  --wisp forest lake
  SpawnNPC(VLK_7000_Weapontrader(), "FP_STAND_SARAH", world);
  SpawnNPC(VLK_7001_Armortrader(), "FP_STAND_JORA", world);
  SpawnNPC(VLK_7002_Hunter(), "FP_STAND_BALTRAM", world);
  SpawnNPC(VLK_7003_Hunter(), "FP_STAND", world);
  SpawnNPC(VLK_7004_Hunter(), "FP_ROAM_TAVERNE_TROLLAREA_02_04", world);
  SpawnNPC(VLK_7005_Armortrader(), "FP_STAND_NW_TAVERNE_IN_RANGERMEETING_04", world);
